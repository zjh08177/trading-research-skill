export const meta = {
  name: 'rewrite-writers-v23',
  description: 'Re-run the opus writer on existing runs with the v2.3 prompt (concrete position + two-sided LEVELS), reusing cached ratings',
  phases: [{ title: 'Writer' }],
}
