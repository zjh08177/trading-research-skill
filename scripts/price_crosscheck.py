#!/usr/bin/env python3
"""Deterministic 2-of-3 live-price cross-check resolution: when the pipeline's
primary live quote (P1.last — currently `uw_quote.py`; vendor-agnostic here,
just reads the pack fact) and tiingo's independent live oracle
(P1.px_last_oob) disagree beyond tolerance, a third independent source
...
back-dated run's settled-close cross-check (tiingo px_close_oob vs primary
